...
namespace GeekShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        {
            //verificando no banco se existe algum cara com perfil de Admin
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "praraujo2010@hotmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (71) 123456789",
                FirstName = "Paulo",
                LastName = "Admin"
            };
            ...
            //atribuindo usuario a uma Role
            _user.AddToRoleAsync(admin, IdentityConfiguration.Admin).GetAwaiter().GetResult();

            //adicionando os claims do usuario
